...
class Track {
    ...
    private String formattedDuration(int totalSeconds) {
        //i get seconds- int length is max 4, and return minutes:seconds as a string 
        
        String str1=String.format("%s:",totalSeconds/100); 
        String str2=String.format("%s",totalSeconds%100); 
